...
## PARTIA 21 — „Ranking WIDE" = kopia Rankingu dnia pod nowe wytyczne ✅ wykonana (Sonnet 02.09, odebrana Fable — spot-check OK, WDROŻONA CC-Win 02.09) (decyzja Rafała 02.09: „dokładna kopia w UI tego rankingu, tylko dla nowych wytycznych — chcę to obserwować"; spec Fable 02.09) ✅ wykonana (Sonnet 02.09; tsc czysty poza preexisting observer:43, build przechodzi tylko preexisting size-limit)
...
## PARTIA 22 — kolumny „365d / 720d wstecz" w OBU tabelach rankingowych ✅ wykonana (Sonnet 02.09, odebrana Fable — spot-check OK, WDROŻONA CC-Win 02.09) (pomysł Rafała 02.09; spec Fable 02.09) ✅ wykonana (Sonnet 02.09; tsc czysty poza preexisting observer:43, build przechodzi tylko preexisting size-limit)
