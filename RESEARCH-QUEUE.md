...
- [x] **E8.2 „DOM KASYNA" — ZAMKNIĘTE 09.09 (wieczór). Na czystych danych (kotwica 12:00 UTC, 100% pokrycia): GM v2 ETH α +9.7%/r (79%), BTC +9.4%/r (88%, 4/4 kryteria); JLP mix3 (ETH/BTC/SOL) α +22%/r (75%, 3/4 — pada worst); GLP (v1, pełny cykl 2022–25) brak edge'u ≈ −2.6%/r + hack −93% (dane E8.2e, wyjątek udokumentowany — Llama obcina chunk przy delistingu). **Bieżące tempo klasy ≈ +5–7%/r i MALEJE rok do roku** (2024 zawyża średnie). WERDYKT: klasa realna i powtarzalna (3 protokoły, 2 łańcuchy), do obserwacji TAK, do kapitału transzy 1 NIE (przy $6k ≈ $300–400/r); na skalę tylko z limitem ≤25%/protokół i ≥2 protokoły. Jedyna klasa z dodatnim edge'em w historii projektu → agenda 24.09. Backlog: ostrzeżenie „chunk < span" w paginacji Llamy (niepilne). CONTEXT 07–09.09.**
