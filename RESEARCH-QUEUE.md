...
- [~] **E8.2 „DOM KASYNA" — GM v2 PRZECHODZI 4/4 (BTC) i 3/4 (ETH), alfa ≈ +9–11%/r ponad HODL 50/50 (3 lata, BEZ bessy, jeden protokół); HLP n/a; E8.2b/c GLP (GMX v1) ZAMKNIĘTE 08.09: przez pełny cykl 2022-09→2025-07 po regresji 2-czynnikowej (βETH 0.26, βBTC 0.12) **α ≈ −2.65%/r, 41% okien — BRAK EDGE'U** (wcześniejsze „+7%/r" = przeciek bety BTC do alfy), + ogon hacku 07.2025 −93%/dzień. E8.2d ZROBIONE 09.09 (CC-Mac): bench `mix` ✓; ZNALEZISKO: dryf cache cen coins.llama → precyzja α ±2–3 pp/r (znak/rząd stoją); JLP (Jupiter, Solana, od 11.2023) mix α +20.6%/r, 66% po korekcie, ale Σβ=0.65 przy ~44% SOL w koszyku → PRAWDOPODOBNIE ZAWYŻONE, maxDD 46% > koszyk. E8.2e ZROBIONE 09.09 (CC-Win): kotwica UTC + `mix3` ✓, dryf ±0.2–1.7 pp/r, klasy bez zmian; ALE kotwica 00:00Z straddluje granicę dnia (pokrycie 58–82% dni) → OTWARTE E8.2f (u CC-Win): kotwica 12:00 UTC w 4 skryptach + rerun. JLP mix3: α ≈ +22%/r, 84%, 3/4 kryteriów (pada worst), Σβ 0.61; **edge klasy GAŚNIE: 2024 → 2026 na JLP/GM-ETH/GM-BTC, recent180 ≈ +5–7%/r** — wstępny werdykt na 24.09: klasa realna, do obserwacji TAK, do kapitału transzy 1 NIE (sens przy skali). Gains odłożone. CONTEXT 08–09.09. GM pools (GMX v2) + HLP (Hyperliquid):**
